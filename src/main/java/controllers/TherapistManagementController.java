...
public class TherapistManagementController {
    ...
    public TableView tblTherapists;
    ...
    public void addTherapist(ActionEvent actionEvent) {
    }

    public void deleteTherapist(ActionEvent actionEvent) {
    }

    public void updateTherapist(ActionEvent actionEvent) {
    }
